...
Two files `index.js` and a database file `covid19IndiaPortal.db` consisting of three tables `state`, `district` and `user`.

The columns of the tables are as shown below,
